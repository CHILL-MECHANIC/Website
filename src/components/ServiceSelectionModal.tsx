...
const serviceOptions: { [key: string]: ServiceOption[] } = {
  ac: [
    ...
    },
    {
      ...
      description: ["Power jet cleaning of indoor unit", "Filter cleaning", "Outdoor unit cleaning", "Cooling performance check", "Drainage system cleaning"],
      price: 599,
    },
    {
      id: "ac-power-jet-2",
      name: "Power Jet Service - 2 AC",
      description: ["Power jet cleaning of 2 indoor units", "Filter cleaning for both units", "Outdoor unit cleaning for both", "Cooling performance check", "Drainage system cleaning"],
      price: 1099,
    },
    {
      id: "ac-power-jet-3",
      name: "Power Jet Service - 3 AC",
      description: ["Power jet cleaning of 3 indoor units", "Filter cleaning for all units", "Outdoor unit cleaning for all", "Cooling performance check", "Drainage system cleaning"],
      price: 1649,
    },
    {
      id: "ac-power-jet-4",
      name: "Power Jet Service - 4 AC",
      description: ["Power jet cleaning of 4 indoor units", "Filter cleaning for all units", "Outdoor unit cleaning for all", "Cooling performance check", "Drainage system cleaning"],
      price: 2199,
    },
    {
      id: "ac-gas-refill",
    ...
    },
    {
      ...
      description: ["Gas recovery and storage", "Pipe disconnection", "Indoor and outdoor unit removal", "Electrical disconnection"],
      price: 799,
    },
    {
    ...
    },
    {
      ...
      description: ["Electrical disconnection", "Careful unit removal", "Bracket removal", "Basic window cleaning"],
      price: 499,
    },
  ],
  refrigerator: [
