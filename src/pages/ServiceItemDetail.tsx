...
const serviceItemDetails = {
  "ac-foam-jet-1": {
    ...
    duration: "2-3 hours",
    warranty: "30 days",
    description: "Advanced foam jet cleaning service for single AC unit with deep cleaning technology.",
    ...
    included: [
      "Foam jet deep cleaning of indoor unit",
  ...
  "ac-foam-jet-2": {
    ...
    duration: "3-4 hours",
    warranty: "30 days",
    description: "Advanced foam jet cleaning service for 2 AC units with comprehensive maintenance.",
    ...
    included: [
      "Foam jet deep cleaning of 2 indoor units",
  ...
  "ac-foam-jet-3": {
    ...
    duration: "4-5 hours",
    warranty: "30 days",
    description: "Advanced foam jet cleaning service for 3 AC units with complete system check.",
    ...
    included: [
      "Foam jet deep cleaning of 3 indoor units",
  ...
  "ac-foam-jet-4": {
    ...
    duration: "5-6 hours",
    warranty: "30 days",
    description: "Advanced foam jet cleaning service for 4 AC units with thorough inspection.",
    ...
    included: [
      "Foam jet deep cleaning of 4 indoor units",
      "Filter cleaning and sanitization for all units",
      "Outdoor unit cleaning for all",
  ...
  "ac-foam-jet-5": {
    ...
    duration: "6-7 hours",
    warranty: "30 days",
    description: "Advanced foam jet cleaning service for 5 AC units with full optimization.",
    ...
    included: [
      "Foam jet deep cleaning of 5 indoor units",
      "Filter cleaning and sanitization for all units",
      "Outdoor unit cleaning for all",
