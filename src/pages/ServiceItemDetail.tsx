...
const SERVICE_ITEM_SEO: Record<string, { title: string; description: string }> = {
  ...
  "ac-water-leakage": { title: "AC Water Leakage Repair Gurgaon | Fix Leaks Fast | Chill Mechanic", description: "Expert AC water leakage repair. Leak detection, drain cleaning, seal repair. Same day service. Book now at ₹799." },
