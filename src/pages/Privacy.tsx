            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <p className="text-muted-foreground">
                  ...
                  <a href="https://www.chillmechanic.com" target="_blank" rel="noopener noreferrer" className="underline text-primary">https://www.chillmechanic.com</a>, mobile application(s), and related services) and constitute a legally binding 
            ...
            <Card>
              ...
              <CardContent>
                ...
                <div className="bg-muted p-4 rounded-lg space-y-2">
                  ...
                  <p className="text-muted-foreground">Registered Office: Gurgaon, Haryana, India</p>
